  ...
  return(
    <div>
      ...
      <div style={{ marginTop: 30 }}>
        <button onClick={ () => { changeUserDetails('name', 'Mohsin K') } }>Change Name</button>
        <button onClick={ () => { changeUserDetails('email', 'mohsinkd786@gmail.com') } }>Change Email Address</button>
      </div>
    </div>
  )
